...
var parseJsonCookie = require("cookie-parser").JSONCookie
...
exports.serializeFlash = function(secret, flash) {
	return "s:" + signCookie("j:" + JSON.stringify(flash), secret)
}

exports.parseFlash = function(secret, cookie) {
	return parseJsonCookie(parseSignedCookie(decodeURIComponent(cookie), secret))
}
