...
describe("UsersDb", function() {
	...
	describe(".create", function() {
		it("must throw given duplicate country and personal ids", function() {
			...
			usersDb.create(new ValidUser(attrs))

			var err
			try { usersDb.create(new ValidUser(attrs)) } catch (ex) { err = ex }
		...
		it("must throw given shorter country", function() {
			var err
			try { usersDb.create(new ValidUser({country: "E"})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
		...
		it("must throw given longer country", function() {
			var err
			try { usersDb.create(new ValidUser({country: "EST"})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given lowercase country", function() {
			var err
			try { usersDb.create(new ValidUser({country: "ee"})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given empty personal_id", function() {
			var err
			try { usersDb.create(new ValidUser({personal_id: ""})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given country without personal_id", function() {
			var err
			try { usersDb.create(new ValidUser({country: "EE", personal_id: null})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given empty name", function() {
			var err
			try { usersDb.create(new ValidUser({name: ""})) } catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given empty official_name", function() {
			var err
			try { usersDb.create(new ValidUser({official_name: ""})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given longer language", function() {
			var err
			try { usersDb.create(new ValidUser({language: "est"})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
		...
		it("must throw given uppercase language", function() {
			var err
			try { usersDb.create(new ValidUser({language: "ET"})) }
			catch (ex) { err = ex }
			err.must.be.an.error(SqliteError)
			err.code.must.equal("constraint")
			err.type.must.equal("check")
